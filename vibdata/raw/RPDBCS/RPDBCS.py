...
_urls_resources = {
    "2022-11-01": (
        ["1ATw19DjzDWbQKOqVKXPOIdOj7v2Vg61V"],
        [("RPDBCS-20221101.zip", "820dd009d911a7929eb769b53ba19b1d")],
    ),
    "2023-01-16": (
        ["1Hz4RXp7Ls669b1xkificvoFCYjOwpT3E"],
        [("RPDBCS-20230116.zip", "e966f975945344a1a0f4eb09d0affeee")],
    ),
    "2023-03-14": (
        ["1kv9aAlRPRj2C4QWXn5sBU0Kx7B-iYfVK"],
        [("RPDBCS-20230314.zip", "1d7274c8a1b3a63b39b9b6c4911580ab")],
    ),
    "2023-04-27": (
        ["1PY_lBNl2HQitV6gyEKRt2SuBy0FSifdn"],
        [("RPDBCS-20230427.zip", "adb5769791e4660f0aa135350170349e")],
    ),
}
...
class RPDBCS_raw(RawVibrationDataset, DownloadableDataset):
    def __init__(
        ...
        **kwargs,
        ...
        if download:
            ...
            super().__init__(root_dir=root_dir, download_resources=resources)
        ...
        self._metainfo["label"] = self._metainfo["label"].apply(
            _convert_label_standard, standard_labels=dataset_centralized_labels
        )
    ...
    def __getitem__(self, i) -> Dict:
        ...
        if self.frequency_domain:
            ...
            raise NotImplementedError("__getitem__ not implemented for " "time domain")
